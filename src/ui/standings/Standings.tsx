	...
	return (
		<details
			className={cn(
				...
				'group/standings open:bg-canvas/50 open:fixed open:top-0 open:bottom-auto open:max-h-svh open:overflow-y-auto open:border open:backdrop-blur-sm',
			)}
		>
			...
			<div className="overflow-y-auto pb-[env(safe-area-inset-bottom)] text-center whitespace-nowrap [&_:is(th,td)]:px-1">
				<table>
